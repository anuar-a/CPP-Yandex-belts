...
extern PROTOBUF_INTERNAL_EXPORT_person_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Address_person_2eproto;
...
static void InitDefaultsAddress_person_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_Address_person_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsAddress_person_2eproto}, {}};
...
void InitDefaults_person_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_Address_person_2eproto.base);
...
const ::google::protobuf::uint32 TableStruct_person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Person, phone_number_),
};
...
const char descriptor_table_protodef_person_2eproto[] =
  ...
  "\t\022\020\n\010building\030\002 \001(\005\"T\n\006Person\022\014\n\004name\030\001 "
  "\001(\t\022\013\n\003age\030\002 \001(\005\022\031\n\007address\030\003 \001(\0132\010.Addr"
  "ess\022\024\n\014phone_number\030\004 \003(\tb\006proto3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_person_2eproto = {
  ...
  "person.proto", &assign_descriptors_table_person_2eproto, 153,
};
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("Address.street");
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 3: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        parser_till_end = ::Address::_InternalParse;
      ...
      case 4: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          ctx->extra_parse_data().SetFieldName("Person.phone_number");
